...
export function mostrarTablaSeleccionada(weatherData, name_location) {
    ...
    const tablaMap = {
        ...
        estacionesPropias: "stations-arduino-table"  // Agregado aquí
    };
    ...
    tablaSelector.forEach(item => {
        item.addEventListener("click", () => {
            ...
            // Generar y mostrar tabla principal
            ...
            // Si es estaciones, también mostrar estacionesPropias
            if (tipo === "estaciones") {
